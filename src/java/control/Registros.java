...
public class Registros extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Respuesta del Servlet en GET </title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Se ha realizado un registro de:  " + us.getNombre() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
     ...
     //   processRequest(request, response);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Respuesta del Servlet en POST </title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Se ha realizado un registro de:  " + us.getNombre() + "</h1>");
            out.println("</body>");
